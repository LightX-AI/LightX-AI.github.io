...
This is the repository that contains source code for the [Light-X website](https://lightx-ai.github.io/).

If you find Light-X useful for your work please cite:
```
